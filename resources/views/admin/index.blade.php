            ...
            <div class="card-body">
                <div class="d-flex">
                    <p class="d-flex flex-column">
                        <span class="text-bold text-lg">Data Ustadzah</span>
                    </p>
            ...
            <div class="card-body">
                ...
                <div class="position-relative mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="chart-legend clearfix">
                                <li><i class="far fa-circle" style="color: #d4c148"></i> Tartil</li>
                                <li><i class="far fa-circle" style="color: #ba6906"></i> Tilawah</li>
                            </ul>
                        </div>
                    </div>
                </div>
