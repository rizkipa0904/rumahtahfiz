...
<body class="hold-transition login-page" style="background-image: url('{{ asset("img/bgttc.jpg") }}'); background-size: cover; background-attachment: fixed;">
  <div class="login-box">
    <div class="login-logo">
      <img src="{{ asset('img/logottc.png') }}" width="100%" alt="">
    </div>
    ...
    <footer style="color: white;">
      <marquee>
          <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> &diams; <a href="http://smkn1jenpo.sch.id/" style="color: white;">Rumah Talamau Tahfidz Center</a>. </strong>
      </marquee>
    </footer>
  </div>
